...
class CIFAR10Instance_double(CIFAR10):
    """CIFAR10Instance Dataset.
    """
    def __init__(self, root='./data', train=True, download=True, transform=None, double=True):
        super(CIFAR10Instance_double, self).__init__(root=root, train=train, download=download, transform=transform)
        self.double = double
